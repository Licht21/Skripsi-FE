...
class MobileImageUploadSection extends StatefulWidget {
  const MobileImageUploadSection({super.key});

  @override
  State<MobileImageUploadSection> createState() => _ImageUploadSectionState();
}

class _ImageUploadSectionState extends State<MobileImageUploadSection> {

...
class InitialTreatment extends StatefulWidget {
  const InitialTreatment({super.key});

  @override
  State<InitialTreatment> createState() => _InitialTreatmentState();
}

class _InitialTreatmentState extends State<InitialTreatment> {
  @override
